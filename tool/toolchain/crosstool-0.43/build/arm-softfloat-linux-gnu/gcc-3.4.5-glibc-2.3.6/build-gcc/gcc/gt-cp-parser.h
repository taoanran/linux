  ...
  if (ggc_test_and_set_mark (x))
    {
      if ((*x).buffer != NULL) {
        size_t i0;
        for (i0 = 0; i0 < (size_t)((((*x)).buffer_end - ((*x)).buffer)); i0++) {
          gt_ggc_m_9tree_node ((*x).buffer[i0].value);
        }
        ggc_mark ((*x).buffer);
      }
      gt_ggc_m_15varray_head_tag ((*x).saved_tokens);
      gt_ggc_m_15varray_head_tag ((*x).string_tokens);
      gt_ggc_m_8cp_lexer ((*x).next);
    }
}

void
gt_ggc_mx_cp_token_block (void *x_p)
{
  struct cp_token_block * const x = (struct cp_token_block *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      {
        size_t i0;
        for (i0 = 0; i0 < (size_t)(CP_TOKEN_BLOCK_NUM_TOKENS); i0++) {
          gt_ggc_m_9tree_node ((*x).tokens[i0].value);
        }
      }
      gt_ggc_m_14cp_token_block ((*x).next);
      gt_ggc_m_14cp_token_block ((*x).prev);
    }
}
...
gt_ggc_mx_cp_token_cache (void *x_p)
{
  ...
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_m_14cp_token_block ((*x).first);
      gt_ggc_m_14cp_token_block ((*x).last);
    }
}
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_8cp_lexer))
    {
      ...
      gt_pch_n_15varray_head_tag ((*x).saved_tokens);
      gt_pch_n_15varray_head_tag ((*x).string_tokens);
      gt_pch_n_8cp_lexer ((*x).next);
    }
}

void
gt_pch_nx_cp_token_block (void *x_p)
{
  struct cp_token_block * const x = (struct cp_token_block *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_14cp_token_block))
    {
      {
        size_t i0;
        for (i0 = 0; i0 < (size_t)(CP_TOKEN_BLOCK_NUM_TOKENS); i0++) {
      ...
      gt_pch_n_14cp_token_block ((*x).next);
      gt_pch_n_14cp_token_block ((*x).prev);
    }
}
...
gt_pch_nx_cp_token_cache (void *x_p)
{
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_14cp_token_cache))
    {
      gt_pch_n_14cp_token_block ((*x).first);
      gt_pch_n_14cp_token_block ((*x).last);
    }
}

void
gt_pch_p_9cp_parser (void *this_obj ATTRIBUTE_UNUSED,
	void *x_p,
...
void
gt_pch_p_17cp_parser_context (void *this_obj ATTRIBUTE_UNUSED,
	void *x_p,
	gt_pointer_operator op ATTRIBUTE_UNUSED,
	void *cookie ATTRIBUTE_UNUSED)
{
...
void
gt_pch_p_8cp_lexer (void *this_obj ATTRIBUTE_UNUSED,
	void *x_p,
	gt_pointer_operator op ATTRIBUTE_UNUSED,
	void *cookie ATTRIBUTE_UNUSED)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).saved_tokens), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).string_tokens), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).next), cookie);
}

void
gt_pch_p_14cp_token_block (void *this_obj ATTRIBUTE_UNUSED,
	void *x_p,
	gt_pointer_operator op ATTRIBUTE_UNUSED,
	void *cookie ATTRIBUTE_UNUSED)
{
  struct cp_token_block * const x ATTRIBUTE_UNUSED = (struct cp_token_block *)x_p;
  {
    size_t i0;
    for (i0 = 0; i0 < (size_t)(CP_TOKEN_BLOCK_NUM_TOKENS); i0++) {
      if ((void *)(x) == this_obj)
...
void
gt_pch_p_8cp_token (void *this_obj ATTRIBUTE_UNUSED,
	void *x_p,
	gt_pointer_operator op ATTRIBUTE_UNUSED,
	void *cookie ATTRIBUTE_UNUSED)
{
...
void
gt_pch_p_14cp_token_cache (void *this_obj ATTRIBUTE_UNUSED,
	void *x_p,
	gt_pointer_operator op ATTRIBUTE_UNUSED,
	void *cookie ATTRIBUTE_UNUSED)
{
